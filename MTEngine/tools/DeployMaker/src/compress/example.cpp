...
static u32 TestRLEPack(u8 *input,const u32 inputLength)
{
	u32 foundLeast[256];
	...
	u8 *work = (u8*) malloc(inputLength + (inputLength / 8));
	u32 outPos = 0;
	// Save the marker
	work[outPos++] = leastIndex;
	...
	memcpy(input,work,outPos);
	free(work);

	return outPos;
}

/* iAN CooG Added this ParamToNum functionality */
static int ParamToNum(char *arg)
{
	int num;
	if(arg[0]=='$')
	{
...
int example_main(int argc,char **argv)
{
	...
	if (argv[1][1] == 'c')
	{
//		inputSize = TestRLEPack(input,inputSize);
