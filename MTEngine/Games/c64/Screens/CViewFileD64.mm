...
CViewFileD64::CViewFileD64(GLfloat posX, GLfloat posY, GLfloat posZ, GLfloat sizeX, GLfloat sizeY)
...
void CViewFileD64::Render(GLfloat posX, GLfloat posY)
{
...
//@returns is consumed
bool CViewFileD64::DoTap(GLfloat x, GLfloat y)
{
	LOGG("CViewFileD64::DoTap:  x=%f y=%f", x, y);
	return CGuiView::DoTap(x, y);
}

bool CViewFileD64::DoFinishTap(GLfloat x, GLfloat y)
{
...
//@returns is consumed
bool CViewFileD64::DoDoubleTap(GLfloat x, GLfloat y)
{
	LOGG("CViewFileD64::DoDoubleTap:  x=%f y=%f", x, y);
	return CGuiView::DoDoubleTap(x, y);
}

bool CViewFileD64::DoFinishDoubleTap(GLfloat x, GLfloat y)
{
	LOGG("CViewFileD64::DoFinishTap: %f %f", x, y);
...
bool CViewFileD64::DoMove(GLfloat x, GLfloat y, GLfloat distX, GLfloat distY, GLfloat diffX, GLfloat diffY)
{
	return CGuiView::DoMove(x, y, distX, distY, diffX, diffY);
}

bool CViewFileD64::FinishMove(GLfloat x, GLfloat y, GLfloat distX, GLfloat distY, GLfloat accelerationX, GLfloat accelerationY)
{
...
bool CViewFileD64::DoZoomBy(GLfloat x, GLfloat y, GLfloat zoomValue, GLfloat difference)
{
...
void CViewFileD64::FinishTouches()
{
...
bool CViewFileD64::KeyDown(u32 keyCode, bool isShift, bool isAlt, bool isControl)
{
...
bool CViewFileD64::KeyUp(u32 keyCode, bool isShift, bool isAlt, bool isControl)
{
...
bool CViewFileD64::KeyPressed(u32 keyCode, bool isShift, bool isAlt, bool isControl)
{
