...
{
	this->name = "CViewVicEditorCreateNewPicture";
...
//	this->AddGuiElement(lblImageMode);
	...
	//
	float sp = 0.85f;
	viewPalette = new CViewC64Palette(px, py, posZ, 150*sp, 30*sp, this);
...
void CViewVicEditorCreateNewPicture::SetPosition(GLfloat posX, GLfloat posY, GLfloat posZ, GLfloat sizeX, GLfloat sizeY)
{
...
bool CViewVicEditorCreateNewPicture::DoTap(GLfloat x, GLfloat y)
{
...
bool CViewVicEditorCreateNewPicture::DoMove(GLfloat x, GLfloat y, GLfloat distX, GLfloat distY, GLfloat diffX, GLfloat diffY)
{
	if (this->IsInsideView(x, y))
		return true;
...
bool CViewVicEditorCreateNewPicture::DoRightClick(GLfloat x, GLfloat y)
{
...
bool CViewVicEditorCreateNewPicture::KeyDown(u32 keyCode, bool isShift, bool isAlt, bool isControl)
{
...
bool CViewVicEditorCreateNewPicture::KeyUp(u32 keyCode, bool isShift, bool isAlt, bool isControl)
{
	return false;
}
...
bool CViewVicEditorCreateNewPicture::SetFocus(bool focus)
{
	return true;
}
