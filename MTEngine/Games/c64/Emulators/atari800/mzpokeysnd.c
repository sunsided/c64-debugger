...
#ifdef NONLINEAR_MIXING
#ifdef SYNCHRONIZED_SOUND
//			LOGD("outvol0=%3d outvol1=%3d outvol2=%3d outvol3=%3d", ps->outvol_0, ps->outvol_1, ps->outvol_2, ps->outvol_3);
			...
			// TODO: Stereo POKEY
			if (atrd_is_receive_channels_data[pokeyChipNo])
			{
				const signed short shiftChannel = 10;
				const signed short shiftAll = 8;
				signed short v0 = ((signed short)pokeymix[ps->outvol_0]) << shiftChannel;
				signed short v1 = ((signed short)pokeymix[ps->outvol_1]) << shiftChannel;
				signed short v2 = ((signed short)pokeymix[ps->outvol_2]) << shiftChannel;
