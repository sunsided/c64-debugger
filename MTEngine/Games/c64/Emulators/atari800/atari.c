...
int Atari800_InitialiseMachine(void)
{
	...
	LOGD("Atari800_InitialiseMachine");
...
//	SYSROM_FindInDir(".", TRUE); /* current directory */
	...
	atariRomFolderPath = ATRD_GetPathForRoms();
	
	LOGM("Atari ROMs are in %s", atariRomFolderPath);
	
	SYSROM_FindInDir(atariRomFolderPath, FALSE); 
