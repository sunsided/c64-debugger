...
#include "a-palette.h"
#include "a-video.h"
#include "a-video_sw.h"
#if HAVE_OPENGL
#include "a-video_gl.h"
#endif
...
{
	desktop_resolution.width = ATARI_DEFAULT_SCREEN_WIDTH;
	desktop_resolution.height = ATARI_DEFAULT_SCREEN_HEIGHT;
...
{	
	...
	LOGD("PLATFORM_AvailableResolutions: return 336x240");
