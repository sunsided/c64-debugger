...
struct snapshot_s;
extern int cartridge_snapshot_read_modules(struct snapshot_s *s, int store_reu_data);
extern int cartridge_snapshot_write_modules(struct snapshot_s *s, int store_reu_data);
