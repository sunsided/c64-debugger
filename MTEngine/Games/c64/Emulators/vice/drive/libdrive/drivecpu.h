...
extern void c64d_get_drivecpu_regs_internal(struct drive_context_s *drv, uint8 *a, uint8 *x, uint8 *y, uint8 *p, uint8 *sp, uint16 *pc);
extern uint8 c64d_peek_mem_drive_internal(struct drive_context_s *drv, uint16 addr);
extern void c64d_peek_whole_map_drive_internal(struct drive_context_s *drv, uint8 *memoryBuffer);
extern uint8 c64d_mem_ram_read_drive_internal(struct drive_context_s *drv, uint16 addr);
extern void c64d_mem_ram_write_drive_internal(struct drive_context_s *drv, uint16 addr, uint8 value);

extern void c64d_copy_mem_ram_drive_internal(struct drive_context_s *drv, uint8 *memoryBuffer);
extern void c64d_peek_memory_drive_internal(struct drive_context_s *drv, BYTE *buffer, uint16 addrStart, uint16 addrEnd);
extern void c64d_copy_ram_memory_drive_internal(struct drive_context_s *drv, BYTE *buffer, uint16 addrStart, uint16 addrEnd);
