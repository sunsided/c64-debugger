...
#include "residfp-voice.h"
#include "residfp-filter.h"
#include "residfp-extfilt.h"
#include "residfp-pot.h"
...
//protected:
  ...
  chip_model model;
	...
	// wave display corrections
	float c64d_wave_attenuation;
	float c64d_wave_shift;
