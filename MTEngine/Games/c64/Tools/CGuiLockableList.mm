...
CGuiLockableList::CGuiLockableList(GLfloat posX, GLfloat posY, GLfloat posZ, GLfloat sizeX, GLfloat sizeY, GLfloat fontSize,
...
bool CGuiLockableList::DoTap(GLfloat x, GLfloat y)
{
...
void CGuiLockableList::Render()
{
	...
	GLfloat drawY = startDrawY + startElementsY;
	GLfloat drawX = startDrawX;
...
bool CGuiLockableList::KeyDown(u32 keyCode, bool isShift, bool isAlt, bool isControl)
{
	guiMain->LockMutex();
