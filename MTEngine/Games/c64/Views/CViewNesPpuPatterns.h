#ifndef _CViewNesPpuPatterns_H_
#define _CViewNesPpuPatterns_H_
...
class CViewNesPpuPatterns : public CGuiView
{
public:
	CViewNesPpuPatterns(GLfloat posX, GLfloat posY, GLfloat posZ, GLfloat sizeX, GLfloat sizeY, NesDebugInterface *debugInterface);
	virtual ~CViewNesPpuPatterns();
