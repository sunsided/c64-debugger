#ifndef _C64VicDisplayCanvasExtendedText_H_
#define _C64VicDisplayCanvasExtendedText_H_

#include "C64VicDisplayCanvas.h"

class C64VicDisplayCanvasExtendedText : public C64VicDisplayCanvas
{
public:
	C64VicDisplayCanvasExtendedText(CViewC64VicDisplay *vicDisplay);
