#ifndef _CViewAtariStateGTIA_H_
#define _CViewAtariStateGTIA_H_
...
class CViewAtariStateGTIA : public CGuiView, CGuiEditHexCallback
{
public:
	CViewAtariStateGTIA(GLfloat posX, GLfloat posY, GLfloat posZ, GLfloat sizeX, GLfloat sizeY, AtariDebugInterface *debugInterface);
