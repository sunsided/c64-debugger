...
: CGuiView(posX, posY, posZ, sizeX, sizeY)
{
	...
	for (int pokeyNum = 0; pokeyNum < MAX_NUM_POKEYS; pokeyNum++)
	{
		...
		{
			pokeyChannelWaveform[pokeyNum][chanNum] = new CViewC64StateSIDWaveform(0, 0, 0, 0, 0);
		}
		pokeyMixWaveform[pokeyNum] = new CViewC64StateSIDWaveform(0, 0, 0, 0, 0);
	}
	waveformPos = 0;
