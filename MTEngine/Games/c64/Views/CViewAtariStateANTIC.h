#ifndef _CViewAtariStateANTIC_H_
#define _CViewAtariStateANTIC_H_
...
class CViewAtariStateANTIC : public CGuiView, CGuiEditHexCallback
{
public:
	CViewAtariStateANTIC(GLfloat posX, GLfloat posY, GLfloat posZ, GLfloat sizeX, GLfloat sizeY, AtariDebugInterface *debugInterface);
