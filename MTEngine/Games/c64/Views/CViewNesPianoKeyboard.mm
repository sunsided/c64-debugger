...
CViewNesPianoKeyboard::CViewNesPianoKeyboard(float posX, float posY, float posZ, float sizeX, float sizeY, CPianoKeyboardCallback *callback)
: CPianoKeyboard(posX, posY, posZ, sizeX, sizeY, callback)
{
	this->name = "CViewNesPianoKeyboard";
...
bool CViewNesPianoKeyboard::KeyDown(u32 keyCode, bool isShift, bool isAlt, bool isControl)
{
...
bool CViewNesPianoKeyboard::KeyUp(u32 keyCode, bool isShift, bool isAlt, bool isControl)
{
//	if (this->HasFocus()
//		|| viewC64->viewC64AllSids->viewTrackerHistory->HasFocus())
//	{
