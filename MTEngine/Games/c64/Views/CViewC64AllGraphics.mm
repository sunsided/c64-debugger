...
//@returns is consumed
bool CViewC64AllGraphics::DoDoubleTap(GLfloat x, GLfloat y)
{
	LOGG("CViewC64AllGraphics::DoDoubleTap:  x=%f y=%f", x, y);
	return CGuiView::DoDoubleTap(x, y);
}

bool CViewC64AllGraphics::DoFinishDoubleTap(GLfloat x, GLfloat y)
{
	LOGG("CViewC64AllGraphics::DoFinishTap: %f %f", x, y);
...
bool CViewC64AllGraphics::DoMove(GLfloat x, GLfloat y, GLfloat distX, GLfloat distY, GLfloat diffX, GLfloat diffY)
{
	return CGuiView::DoMove(x, y, distX, distY, diffX, diffY);
}

bool CViewC64AllGraphics::FinishMove(GLfloat x, GLfloat y, GLfloat distX, GLfloat distY, GLfloat accelerationX, GLfloat accelerationY)
{
...
bool CViewC64AllGraphics::DoZoomBy(GLfloat x, GLfloat y, GLfloat zoomValue, GLfloat difference)
{
...
void CViewC64AllGraphics::FinishTouches()
{
	return CGuiView::FinishTouches();
}

bool CViewC64AllGraphics::KeyDown(u32 keyCode, bool isShift, bool isAlt, bool isControl)
{
	return CGuiView::KeyDown(keyCode, isShift, isAlt, isControl);
}

bool CViewC64AllGraphics::KeyUp(u32 keyCode, bool isShift, bool isAlt, bool isControl)
{
	return CGuiView::KeyUp(keyCode, isShift, isAlt, isControl);
}

bool CViewC64AllGraphics::KeyPressed(u32 keyCode, bool isShift, bool isAlt, bool isControl)
{
