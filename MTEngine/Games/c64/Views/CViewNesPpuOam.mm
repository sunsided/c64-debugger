...
CViewNesPpuOam::CViewNesPpuOam(GLfloat posX, GLfloat posY, GLfloat posZ, GLfloat sizeX, GLfloat sizeY, NesDebugInterface *debugInterface)
: CGuiView(posX, posY, posZ, sizeX, sizeY)
{
	this->name = "CViewNesPpuOam";
...
void CViewNesPpuOam::SetPosition(GLfloat posX, GLfloat posY, GLfloat posZ, GLfloat sizeX, GLfloat sizeY)
{
	CGuiView::SetPosition(posX, posY, posZ, sizeX, sizeY);
}

void CViewNesPpuOam::Render(GLfloat posX, GLfloat posY)
{
	CGuiView::Render(posX, posY);
}

//@returns is consumed
bool CViewNesPpuOam::DoTap(GLfloat x, GLfloat y)
{
	LOGG("CViewNesPpuOam::DoTap:  x=%f y=%f", x, y);
	return CGuiView::DoTap(x, y);
}

bool CViewNesPpuOam::DoFinishTap(GLfloat x, GLfloat y)
{
...
//@returns is consumed
bool CViewNesPpuOam::DoDoubleTap(GLfloat x, GLfloat y)
{
	LOGG("CViewNesPpuOam::DoDoubleTap:  x=%f y=%f", x, y);
	return CGuiView::DoDoubleTap(x, y);
}

bool CViewNesPpuOam::DoFinishDoubleTap(GLfloat x, GLfloat y)
{
	LOGG("CViewNesPpuOam::DoFinishTap: %f %f", x, y);
...
bool CViewNesPpuOam::DoMove(GLfloat x, GLfloat y, GLfloat distX, GLfloat distY, GLfloat diffX, GLfloat diffY)
{
	return CGuiView::DoMove(x, y, distX, distY, diffX, diffY);
}

bool CViewNesPpuOam::FinishMove(GLfloat x, GLfloat y, GLfloat distX, GLfloat distY, GLfloat accelerationX, GLfloat accelerationY)
{
...
bool CViewNesPpuOam::DoZoomBy(GLfloat x, GLfloat y, GLfloat zoomValue, GLfloat difference)
{
...
void CViewNesPpuOam::FinishTouches()
{
	return CGuiView::FinishTouches();
}

bool CViewNesPpuOam::KeyDown(u32 keyCode, bool isShift, bool isAlt, bool isControl)
{
	LOGI(".......... CViewNesPpuOam::KeyDown: keyCode=%d", keyCode);
	return CGuiView::KeyDown(keyCode, isShift, isAlt, isControl);
}

bool CViewNesPpuOam::KeyUp(u32 keyCode, bool isShift, bool isAlt, bool isControl)
{
	LOGI(".......... CViewNesPpuOam::KeyUp: keyCode=%d", keyCode);
	return CGuiView::KeyUp(keyCode, isShift, isAlt, isControl);
}

bool CViewNesPpuOam::KeyPressed(u32 keyCode, bool isShift, bool isAlt, bool isControl)
{
