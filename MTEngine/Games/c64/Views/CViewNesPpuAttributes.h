#ifndef _CViewNesPpuAttributes_H_
#define _CViewNesPpuAttributes_H_
...
class CViewNesPpuAttributes : public CGuiView
{
public:
	CViewNesPpuAttributes(GLfloat posX, GLfloat posY, GLfloat posZ, GLfloat sizeX, GLfloat sizeY, NesDebugInterface *debugInterface);
	virtual ~CViewNesPpuAttributes();
...
#endif //_CViewNesPpuAttributes_H_
